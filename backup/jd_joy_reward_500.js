...
function init() {
  return new Promise(resolve => {
    $.get({
      url: `https://jdjoy.jd.com/common/gift/getBeanConfigs?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      headers: {
        'Host': 'jdjoy.jd.com',
        'accept': '*/*',
...
function exchange(beanId) {
  ...
  return new Promise(resolve => {
    $.post({
      url: `https://jdjoy.jd.com/common/gift/new/exchange?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      headers: {
        "Host": "jdjoy.jd.com",
        "Accept-Language": "zh-cn",
        "Content-Type": "application/json",
